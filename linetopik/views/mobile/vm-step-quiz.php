            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-10 col-md-offset-1" style="">
                        ...
                        <form action="<?= base_url('index.php/linetopik/cekjawaban') ?>" method="post" id="hasil_quiz">
                            ...
                            <div class="col-md-8" id="myContent" hidden="">
                                <div class="panel panel-default"  style="min-height:170px; margin-left: 60px; margin-right: 10px;"> 
                                        ...
                                        <div class="panel-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-12" style="">
                                                    <hr> 
                                                    <button type="button" class="btn btn-info btn-block" onclick="kirimHasilQuiz();">Kumpulkan Jawaban</button>
                                                </div>
