...
public function pertanyaan_mentor(){
  ...
  $data['files'] = array(
    APPPATH.'modules/templating/views/anggi/v-sidebar.php',
    APPPATH.'modules/konsultasi/views/mobile/vm-daftar-konsultasi_mentor.php',
    APPPATH.'modules/konsultasi/views/v-show-tingkat.php',
    APPPATH.'modules/templating/views/anggi/v-footer.php'
    );
...
public function pertanyaan_all() {
  ...
  $data['files'] = array(
    APPPATH.'modules/templating/views/anggi/v-sidebar.php',
    APPPATH.'modules/konsultasi/views/mobile/vm-daftar-konsultasi_all.php',
    APPPATH.'modules/konsultasi/views/v-show-tingkat.php',
    APPPATH.'modules/templating/views/anggi/v-footer.php'
    );
...
public function pertanyaan_grade() {
  ...
  $data['files'] = array(
    APPPATH.'modules/templating/views/anggi/v-sidebar.php',
    APPPATH.'modules/konsultasi/views/mobile/vm-daftar-konsultasi_grade.php',
    APPPATH.'modules/konsultasi/views/v-show-tingkat.php',
    APPPATH.'modules/templating/views/anggi/v-footer.php'
    );
...
public function bertanya($bab){
  ...
  $data['files'] = array(
    APPPATH.'modules/templating/views/anggi/v-sidebar.php',
    APPPATH.'modules/konsultasi/views/mobile/vm-create-konsultasi.php',
    APPPATH.'modules/templating/views/anggi/v-footer.php'
    );
  $this->parser->parse( 'templating/anggi/index', $data );
}
...
public function editpost($id){
  ...
  if ($data_edit) {
    ...
    $data['files'] = array(
      APPPATH.'modules/templating/views/anggi/v-sidebar.php',
      APPPATH.'modules/konsultasi/views/mobile/vm-edit-jawaban.php',
      APPPATH.'modules/templating/views/anggi/v-footer.php'
      );
...
function singlekonsultasi($id_pertanyaan){
  ...
  $data = array(
    ...
    'photo'=>base_url("assetsnew/image/photo/siswa/".$single_pertanyaan['photo'])
    );
  ...
  $data['files'] = array(
    APPPATH.'modules/templating/views/anggi/v-sidebar.php',
    APPPATH.'modules/konsultasi/views/mobile/vm-single-konsultasi.php',
    APPPATH.'modules/templating/views/anggi/v-footer.php'
    );
  $this->parser->parse( 'templating/anggi/index', $data );
}
...
if (!empty($matapelajaran)) {
    ...
    $data['files'] = array(
      APPPATH.'modules/templating/views/anggi/v-header-login.php',
      APPPATH.'modules/konsultasi/views/mobile/vm-daftar-konsultasi_mentor.php',
      APPPATH.'modules/konsultasi/views/v-show-tingkat.php',
      APPPATH.'modules/templating/views/anggi/v-footer.php'
      );
