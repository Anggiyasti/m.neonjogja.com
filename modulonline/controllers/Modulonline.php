...
class Modulonline extends MX_Controller {
 ...
 ##Start Function untuk halaman soal per mata pelajaran##
    ...
    public function allmodul() {
        ...
        // $data['addtop'] = array(
        //     APPPATH.'modules/modulonline/views/mobile/allmodul/addtop-allmodul.php',
        // );
        // $data['addbot'] = array(
        //     APPPATH.'modules/modulonline/views/mobile/allmodul/addbot-allmodul.php',
        // );
        $data['files'] = array( 
            ...
            APPPATH.'modules/modulonline/views/mobile/allmodul/vc-allmodul.php',
            APPPATH.'modules/templating/views/layouts/v-footer.php',
        );
